//IFPROMPTImaGENNode.js
import { app } from "/scripts/app.js";

app.registerExtension({
    name: "Comfy.IFPROMPTImaGENNode",
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "IF_PROMPTImaGEN") {
            ...
            nodeType.prototype.onNodeCreated = function() {
                ...
                const saveComboSettings = this.addWidget("button", "Store Auto Prompt", null, () => {
                    ...
                    fetch("/IF_PROMPTImaGEN/save_combo_settings", {
                        method: "POST",
                ...
                const updateLLMModels = async () => {
                    ...
                    if (llmProviderWidget && baseIpWidget && portWidget && llmModelWidget) {
                        try {
                            const response = await fetch("/IF_PROMPTImaGEN/get_llm_models", {
                                method: "POST",
                                headers: { "Content-Type": "application/json" },
                                body: JSON.stringify({
